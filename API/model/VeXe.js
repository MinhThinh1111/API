...
const VeXe = {
    ...
    insert:(data,callback)=>{
        return conn.query(`INSERT INTO vexe(Id_ChuyenDi,Id_HanhKhach,DiemDon,DiemTra,TrangThai,TongTien,thanhtoan) 
        VALUES ('${data.Id_ChuyenDi}' , '${data.Id_HanhKhach}' , '${data.DiemDon}', 
        '${data.DiemTra}', '${data.TrangThai}' , '${data.TongTien}','${data.thanhtoan}')`,callback);
    },
